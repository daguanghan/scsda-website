...
export const leadershipResponsibilities = [
  {
    ...
    text:
      "Setting the Academy's research agenda across smart cities, digital built environments, sensing, infrastructure intelligence, and sustainable development."
  },
  {
    title: "Research-Centre Formation",
    text:
      "Coordinating the formation of research centres and laboratories with academic and enterprise partners during the platform-construction period."
  },
  {
  ...
  },
  {
    ...
    text:
      "Connecting European research expertise with Chongqing-based applied research, engineering education, and public knowledge exchange."
  },
  {
    title: "Externally Supported Project Delivery",
    text:
      "Leading the organisation, coordination, and reporting of the Academy's platform-construction work during 2019-2023."
  }
];
...
export const caseStudies = [
  ...
  {
    title: "Smart Infrastructure and Monitoring Systems",
  ...
  {
    title: "Digital Operations and Sustainable Urban Systems",
